...
import 'package:my_laptop_harbor_project/Branddetails.dart';
...
class _AddbrandState extends State<Addbrand> {
  ...
  final brandRef  = FirebaseDatabase.instance.ref('Brand');
  @override
     ...
     Center(
       ...
       ElevatedButton(
              ...
              brandRef
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=>Branddetails()),);
