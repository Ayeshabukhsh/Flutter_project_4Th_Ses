...
import 'package:my_laptop_harbor_project/Editbrand.dart';
...
class _BranddetailsState extends State<Branddetails> {
  ...
  Future<void> _getUser() async {
   ...
   final auth = FirebaseAuth.instance;
    final ref = FirebaseDatabase.instance.ref('Brand');
     //Mehtod Delete Data
    void _deleteBrand (String brandId) async{
      await ref.child(brandId).remove();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(
  title: Text("My Brand Details Page"),
      ...
      body: Stack(
       ...
       Center( child: Container( 
          ...
          height: 400, 
           ...
           alignment: Alignment.center, decoration: BoxDecoration( color: Colors.blue,
